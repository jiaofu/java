...
public class ArithmeticUtil {
    ...
    public static String roundDownStr(BigDecimal v) {
        if (v == null) {
            throw new IllegalArgumentException("The BigDecimal must be number or zero");
        }
        return v.divide(one, DEF_DIV_SCALE, BigDecimal.ROUND_DOWN).toPlainString();
    }
