...
/**
 * Created by xxshic on 2018/12/17.
 */
public class DES {
    /**
     * 加密、解密key.
    ...
    public static final String DEFAULT_CRYPT_KEY="kEHrDooxWHCWtfeSxvDvgqZq";
    /**
    ...
    @Value("${des.secret}")
    private void setPasswordCryptKey(String secret) {
        PASSWORD_CRYPT_KEY = secret;
    }
    ...
    public static String getCryptKey(){
        String cryptKey=PASSWORD_CRYPT_KEY;
        if(StringUtil.isEmpty(cryptKey)){
            cryptKey=DEFAULT_CRYPT_KEY;
        }
        return cryptKey;
    }
